...
document.addEventListener('DOMContentLoaded', () => {
  ...
  btnEnviar.addEventListener('click', (e) => {
    ...
    // === PERGUNTA 4 === (tipo radio com formula)
    const p4 = document.querySelector('input[name="pergunta 4"]:checked');
    if (p4) {
      // Compara ignorando espacos entre os caracteres
    ...
    // Preenche os campos ocultos do formulario com os dados do quiz
...
document.getElementById('campoResumo').value = respostasResumo.trim();
    ...
    // Exibe o resultado para o usuario na tela
